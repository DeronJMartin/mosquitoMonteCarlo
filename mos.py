...
# Print results
print("Probability of mosqutio finding the human: ", round(success_states/sims, 4))
print("Probability of mosqutio dying further than 1000m: ", round(outside_states/sims, 4))